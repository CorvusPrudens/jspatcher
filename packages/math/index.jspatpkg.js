...
class Exp extends _common_web_jsDspProcessor__WEBPACK_IMPORTED_MODULE_0__["default"] {
  process(inputs, outputs, parameters) {
    let in1 = inputs[0][0];
    let outputStream = outputs[0][0];
    for (let i = 0; i < in1.length; i++) {
...
class Log extends _common_web_jsDspProcessor__WEBPACK_IMPORTED_MODULE_0__["default"] {
  process(inputs, outputs, parameters) {
    let in1 = inputs[0][0];
    let in2 = inputs[0][1];
    let outputStream = outputs[0][0];
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ Sqrt)
/* harmony export */ });
/* harmony import */ var _common_web_jsDspProcessor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../../../../common/web/jsDspProcessor */ "../../common/web/jsDspProcessor.ts");

class Sqrt extends _common_web_jsDspProcessor__WEBPACK_IMPORTED_MODULE_0__["default"] {
  process(inputs, outputs, parameters) {
    let in1 = inputs[0][0];
    let outputStream = outputs[0][0];
    for (let i = 0; i < in1.length; i++) {
