...
import AbstractUI, {
  AbstractUIProps,
  AbstractUIState,
} from "./AbstractHardwareUI";
import type BaseObject from "./BaseHardwareObject";
import "./BaseHardwareUI.scss";

export interface BaseUIProps<T extends BaseObject = BaseObject>
  extends AbstractUIProps<T> {
  containerProps?: JSX.IntrinsicAttributes &
...
export default class BaseUI<
  ...
  P extends Partial<BaseUIProps<T>> & Record<string, any> = {},
  S extends Partial<BaseUIState> & Record<string, any> = {},
> extends AbstractUI<T, P & BaseUIProps<T>, S & BaseUIState> {
