...
midiFormat.props = {
  pitchBendResolution: {
    ...
    default: "float",
    description: "Pitch Bend Resolution (14-bit (-8192 to 8191), 7-bit (0 to 128), float (-1 to 1))"
  }
};
...
const _midiIn = class extends _base__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor() {
    ...
    this.newSearch = async (search) => {
      ...
      if (!found)
        this.info("Unable to find requested MIDI device for input.");
    };
  }
  subscribe() {
    super.subscribe();
...
const _midiOut = class extends _base__WEBPACK_IMPORTED_MODULE_1__["default"] {
  constructor() {
    ...
    this.newSearch = async (search) => {
      ...
      if (!found)
        this.info("Unable to find requested MIDI device for output.");
    };
  }
  subscribe() {
    super.subscribe();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ MonoVoice)
/* harmony export */ });
/* harmony import */ var _sdk__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../sdk */ "./src/sdk.ts");


class MonoVoice extends _sdk__WEBPACK_IMPORTED_MODULE_0__.DefaultObject {
  constructor() {
    super(...arguments);
    //   static docs: string = "utilities/docs/ftom.html";
    this._ = { notes: [], lastNote: 69, velocity: 0, bend: 0 };
  }
  subscribe() {
    super.subscribe();
    this.on("preInit", () => {
...
MonoVoice.package = "midi";
MonoVoice.author = "Corvus Prudens";
MonoVoice.version = "1.0.0";
MonoVoice.description = "Get a mono voice from a MIDI note stream";
MonoVoice.inlets = [
  {
    isHot: true,
    type: "anything",
...
module.exports = JSON.parse('{"name":"@electrosmith/package-midi","version":"1.0.2","description":"The MIDI package for JSPatcher","main":"dist/index.js","scripts":{"build":"webpack --mode development","build-watch":"webpack --mode development --watch --stats-children"},"keywords":["jspatcher"],"jspatcher":{"isJSPatcherPackage":true,"thumbnail":"","jspatpkg":"index.jspatpkg.js"},"author":"Fr0stbyteR","license":"GPL-3.0-or-later","repository":"https://github.com/jspatcher/package-midi","devDependencies":{"@jspatcher/jspatcher":"file:../../../frontend","@types/webmidi":"^2.0.6","clean-webpack-plugin":"^4.0.0","esbuild-loader":"^2.18.0","semantic-ui-react":"^2.0.4","typescript":"^4.5.4","webpack":"^5.65.0","webpack-cli":"^4.9.1","worklet-loader":"^2.0.0"}}');
...
/* harmony import */ var _objects_monoVoice__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./objects/monoVoice */ "./src/objects/monoVoice.ts");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (async () => {
  return {
    mididevice: _objects_devices__WEBPACK_IMPORTED_MODULE_0__["default"],
    ...
    // makenote: makeNote,
    monovoice: _objects_monoVoice__WEBPACK_IMPORTED_MODULE_5__["default"]
  };
});
